/*
1. under if condition, we cannot use break

2. 
*/

//Logical operator can be defined outside the function
if (2 > 1) {
    console.log("conditional check is not defined in any function");
}
...
//Calculation of the grade for the marks
